...
|     | Функция                                                  | Что делает                                                                                                                                                                                                                       |
| --- | -------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🤖   | **Дисциплинированные агенты**                            | Sisyphus оркестрирует Oracle, Librarian, Explore, Metis и Momus. Сфокусированная AI-команда разработки в параллельном режиме.                                                                                                           |
...
<table><tr> <td align="center"><img src=".github/assets/sisyphus.png" height="300" /></td> </tr></table>
...
Если нужна точность, сначала попросите агента составить план. Он **интервьюирует вас как настоящий инженер**, определяет объём работ и неоднозначности, формирует проверенный план до прикосновения к коду.
...
- **Инструменты продуктивности**: Comment Checker, Think Mode и другое
