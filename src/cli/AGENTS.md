...
Common patterns: Claude/OpenAI/Gemini are preferred when an agent chain includes them, `librarian` prefers ZAI, and `sisyphus` falls back through Kimi then GLM-5.
