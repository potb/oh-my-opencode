...
import { createAgentToolRestrictions } from "../shared/agent-permissions"
...
**Pre-Analysis Guidance** (recommend before questioning):
\`\`\`
// Recommend these background investigations FIRST
