...
describe("category-skill-reminder hook", () => {
  ...
  describe("target agent detection", () => {
    ...
    test("should inject reminder for sisyphus agent during bash work", async () => {
  ...
  describe("delegation tool tracking", () => {
    ...
    test("should NOT inject reminder if task is used before direct work", async () => {
      // given - sisyphus agent that uses task
      const hook = createHook()
